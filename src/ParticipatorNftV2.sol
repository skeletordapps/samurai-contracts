...
contract ParticipatorNftV2 is Ownable, Pausable, ReentrancyGuard {
        ...
        whenUsingToken
    {
        ...
        ERC20(tokenAddress).safeTransferFrom(msg.sender, address(this), amount * pricePerToken);
    }
    ...
    function participateETH(uint256 amount) external payable whenNotPaused whenUsingETH nonReentrant {
        ...
        require(msg.value == amount * pricePerToken, IParticipator.IParticipator__Unauthorized("Insufficient ETH"));
